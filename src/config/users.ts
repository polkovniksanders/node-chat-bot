...
export const REGISTERED_USERS: RegisteredUser[] = [
  {
    ...
    firstName: 'Андрей',
    description:
      'Замечательный друг и любитель кальяна. Стильно одевается и очень уважает свою семью и друзей. Всегда поддержит добрым словом',
  },
  {
    id: 5492444,
    username: 'berghub',
  ...
  },
  {
    ...
    firstName: 'Резида',
    description:
      'Девушка 30-35 лет. Работает удалённо на маркетплейсах, замужем. В общении добра, но бывает хитрой. Любит попугая Твитти.',
  },
];
