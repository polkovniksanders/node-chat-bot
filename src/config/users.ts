...
export const REGISTERED_USERS: RegisteredUser[] = [
  ...
  },
  {
    ...
    description:
      'Мужчина ближе к 40 годам. Женат, есть дочь 7 лет. Самый умный и уважаемый человек в группе — это все признают, хотя вслух не всегда говорят. Солидный, взвешенный, любит когда всё по делу.',
  },
  {
    id: 942510836,
    username: 'Eset74',
